...
def step_00_intro_qiime_subsets_or_repeat (path, nodes, ntasks_per_node, cpus_per_task, identifier, s, qiime_version, path_qiime, path_python, forward_barcodes_file): #old
    bash_00_intro_qiime_subsets_or_repeat = ("#!/bin/bash" + "\n"
                       + "#SBATCH --job-name=" + identifier + "\n"
                       + "#SBATCH --nodes=" + nodes + "\n"
                       + "#SBATCH --ntasks-per-node=" + ntasks_per_node  + "\n"
                       + "#SBATCH --cpus-per-task=" + cpus_per_task + "\n\n"                       
                       ...
                       + "cp" + s + "-u" + s + identifier + "@*_R1_*.fastq.gz" + s + path + identifier + "/" + "\n"
                       + "cp" + s + "-u" + s + identifier + "@*_R2_*.fastq.gz" + s + path + identifier + "/" + "\n"
                       + "cp" + s + "-u" + s + identifier + "@*_R1_*.fastq.gz" + s + path + identifier + "/raw_data/forward.fastq.gz" + "\n"
                       + "cp" + s + "-u" + s + identifier + "@*_R2_*.fastq.gz" + s + path + identifier + "/raw_data/reverse.fastq.gz" + "\n"

                                             
                       + "cp" + s + identifier + "*_bash_step_*.sh" + s + path + identifier + "/" + "\n" 
                       #+ "cp" + s + "-u" + s + path + "/" + identifier + "@metadata.txt" + s + path + identifier + "/" + "\n"
                       + "cp" + s + path_python + "qiime2_subsampling_quality_check.py" + s + path + identifier + "/" + "\n"     
                       + "cp" + s + identifier + "@" + forward_barcodes_file + s + path + identifier + "/" + "\n"
                       + "cd" + s + path + identifier + "\n"
                       + "gunzip" + s + "-k" + s + path + identifier + "/"  + identifier + "@*_R1_*.fastq.gz" + "\n"
    ...
    return bash_00_intro_qiime_subsets_or_repeat
...
for identifier in file_list:
    ...
    sbatchfile = (identifier + "_bash_step_01_qiime_scripts_all_in_1.sh")
    ...
    bash_00_intro_qiime_subsets_or_repeat =  step_00_intro_qiime_subsets_or_repeat (path, nodes, ntasks_per_node, cpus_per_task, identifier, s, qiime_version, path_qiime, path_python, forward_barcodes_file)
    ...
    text_to_write =  ( bash_00_intro_sub_quality + "\n" + bash_01_import + "\n" +  bash_02_demux + "\n"
                       + bash_03_demuxsum + "\n" + bash_04_cutadapt + "\n" + bash_05_trimsum + "\n"
    ...
    text_to_write_2 =  ( bash_00_intro_sub_quality + "\n" + "source deactivate" )


    text_to_write_3 =  ( bash_00_intro_qiime_subsets_or_repeat + "\n" + bash_01_import + "\n" +  bash_02_demux + "\n"
                       + bash_03_demuxsum + "\n" + bash_04_cutadapt + "\n" + bash_05_trimsum + "\n"
                       + bash_06_dada2 + "\n" + bash_07_metadata_tab + "\n" + bash_08_feature_table_sum + "\n"
                       + bash_09_representative_seqs + "\n" + bash_10_align_mafft + "\n" + bash_11_align_mask + "\n"
                       + bash_12_phyl_fast + "\n" + bash_13_phyl_mid  + "\n" + bash_14_feature_class + "\n"
